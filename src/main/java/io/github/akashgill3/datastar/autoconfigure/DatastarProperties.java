 ...
 *
 * <p>This record holds all configurable properties for Datastar behavior, bound from application
 * configuration using the {@code datastar} prefix. Properties can be configured in {@code

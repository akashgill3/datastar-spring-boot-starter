 ...
 *
 * <p>These options control how a patch is applied (selector, patch mode, namespace,
 * useViewTransition) and how the event is delivered over SSE (event ID and retry duration).
 *
 * <p>Typical usage:
 *
 * <pre>

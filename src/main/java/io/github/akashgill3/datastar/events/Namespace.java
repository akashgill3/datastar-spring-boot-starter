 ...
 *
 * <p>This controls which namespace the browser uses when parsing the incoming markup (e.g., HTML
 * vs. SVG).
 *
 * <p>Available namespaces:
 *
 * <ul>
 *   <li>{@link #HTML} - standard HTML
 *   <li>{@link #SVG} - SVG elements
 *   <li>{@link #MATHML} - MathML elements
 * </ul>
 *
 * @author Akash Gill
 */

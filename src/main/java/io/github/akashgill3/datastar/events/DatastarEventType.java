 ...
 *
 * <p>These values map directly to the SSE {@code event: ...} field. They are used by {@code
 * DatastarSseEmitter} when formatting events.
 *
 * <p>Supported event types:
 *
 * <ul>
 *   <li>{@link #PATCH_ELEMENTS} - {@code datastar-patch-elements}
 *   <li>{@link #PATCH_SIGNALS} - {@code datastar-patch-signals}
 * </ul>
 *
 * @author Akash Gill
 */
